...
describe("primeCodexPoolQuotas", () => {
  ...
  test("partial and credit updates keep each carried window's original age", () => {
    ...
    setAccountQuotaFromParsed("dated", { weeklyPercent: 100, monthlyPercent: 100 }, undefined, undefined, undefined, undefined, undefined,
  ...
  test("clearing quota fences an older in-flight observation", () => {
    ...
    expect(setAccountQuotaFromParsed("cleared", { weeklyPercent: 100 }, undefined, undefined, undefined, undefined, undefined, observation)).toBe(false);
